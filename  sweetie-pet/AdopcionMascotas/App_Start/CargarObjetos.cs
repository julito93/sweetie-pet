...
namespace AdopcionMascotas.App_Start
{
    public class CargarObjetos
    {
        public static void cargar (ApplicationDbContext ctx)
        {
            ...
            {
                new Foto{ ID = 1, Url="/img/1/1(1).jpg"},
                new Foto{ ID = 2, Url="/img/1/1(2).jpg"},
                new Foto{ ID = 3, Url="/img/1/1(3).jpg"},
                new Foto{ ID = 4, Url="/img/2/2(1).jpg"},
                new Foto{ ID = 5, Url="/img/2/2(2).jpg"},
                new Foto{ ID = 6, Url="/img/2/2(3).jpg"},
                new Foto{ ID = 7, Url="/img/3/3(1).jpg"},
                new Foto{ ID = 8, Url="/img/3/3(2).jpg"},
                new Foto{ ID = 9, Url="/img/3/3(3).jpg"},
                new Foto{ ID = 10, Url="/img/3/3(4).jpg"},
                new Foto{ ID = 11, Url="/img/3/3(5).jpg"},
                new Foto{ ID = 12, Url="/img/4/4(1).jpg"},
                new Foto{ ID = 13, Url="/img/4/4(2).jpg"},
                new Foto{ ID = 14, Url="/img/4/4(3).jpg"},
                new Foto{ ID = 15, Url="/img/4/4(4).jpg"},
                new Foto{ ID = 16, Url="/img/4/4(5).jpg"},
                new Foto{ ID = 17, Url="/img/4/4(6).jpg"},
                new Foto{ ID = 18, Url="/img/5/5(1).jpg"},
                new Foto{ ID = 19, Url="/img/5/5(2).jpg"},
                new Foto{ ID = 20, Url="/img/5/5(3).jpg"},
                new Foto{ ID = 21, Url="/img/5/5(4).jpg"},
                new Foto{ ID = 22, Url="/img/5/5(5).jpg"},
                new Foto{ ID = 23, Url="/img/5/5(6).jpg"},
                new Foto{ ID = 24, Url="/img/6/6(1).jpg"},
                new Foto{ ID = 25, Url="/img/6/6(2).jpg"},                
                new Foto{ ID = 26, Url="/img/6/6(3).jpg"},
                new Foto{ ID = 27, Url="/img/6/6(4).jpg"},
                new Foto{ ID = 28, Url="/img/6/6(5).jpg"},
                new Foto{ ID = 29, Url="/img/7/7(1).jpg"},
                new Foto{ ID = 30, Url="/img/7/7(2).jpg"},
                new Foto{ ID = 31, Url="/img/7/7(3).jpg"},
                new Foto{ ID = 32, Url="/img/8/8(1).jpg"},
                new Foto{ ID = 33, Url="/img/8/8(2).jpg"},
                new Foto{ ID = 34, Url="/img/9/9(1).jpg"},
                new Foto{ ID = 35, Url="/img/9/9(2).jpg"},
                new Foto{ ID = 36, Url="/img/10/10(1).jpg"},
            };
